        ...
        if not gripper_cal_dir.is_dir():
            ...
            with ExifToolHelper() as et:
                for mp4_path in iter_real_mp4s(input_dir):
                    ...
                    # Check if the current video matches the specified video name
                    if specific_video_name in mp4_path.name:
                        print(f"Using user-specified video {mp4_path.name} for gripper calibration.")
